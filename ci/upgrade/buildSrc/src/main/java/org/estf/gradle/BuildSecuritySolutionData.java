...
import org.estf.gradle.rest.BankAccountBulkEndpoint;
 ...
 *
 */
public class BuildSecuritySolutionData extends DefaultTask {
    ...
    public void uploadBankAccountData() throws IOException, InterruptedException {
        ...
        BankAccountBulkEndpoint endpoint = new BankAccountBulkEndpoint(esBaseUrl);
...
//            HttpResponse response = client.execute(postRequest);
            HttpResponse response = endpoint.sendPostFileRequest(username, password);
